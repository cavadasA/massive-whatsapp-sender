                ...
                <div className='col px-4 py-4'>
                    {whatsappLinks.length !== 0 ? (
                        ...
                        <div>
                            ...
                            <p>Puedes usar el botón de <b><i>I</i></b> para que el texto que selecciones se envíe en formato de cursiva en whatsapp.</p>
                            <p>También puedes usar el botón de <b>B</b> para que el texto seleccionado se envíe en formato de negrita en whatsapp.</p>
                            <br />
